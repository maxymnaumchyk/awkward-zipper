...
TrackState.ProjectionClass2D = vector.TwoVectorArray
TrackState.ProjectionClass3D = vector.ThreeVectorArray
TrackState.ProjectionClass4D = TrackState
TrackState.MomentumClass = vector.LorentzVectorArray
